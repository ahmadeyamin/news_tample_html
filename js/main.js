...
, function(t, e, n) {
    ...
    var T, O = "resize.w3 orientationchange.w3 load.w3";
    function b(t, e) {
        var n = []
          , r = {};
    ...
    (r.resize = b(c, O)),
    (r.scroll = b(c, "scroll.w3 resize.w3 orientationchange.w3 load.w3")),
    (r.redraw = b()),
    ...
    t.exports = function(t, e, n, c, s, f) {
        ...
        f.set(e, t); ++h < d; ) {
            var _ = t[h]
              , y = e[h];
            if (c)
                var m = l ? c(y, _, h, e, t, f) : c(_, y, h, t, e, f);
            if (void 0 !== m) {
                if (m)
                    continue;
                E = !1;
...
, function(t, e, n) {
    ...
    r.define("brand", (t.exports = function(t) {
        var e, n = {}, i = document, o = t("html"), a = t("body"), u = ".w-w3-badge", c = window.location, s = /PhantomJS/i.test(navigator.userAgent), f = "fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange";
        function l() {
        ...
        return ((n.ready = function() {
            ...
            /\.w3\.io$/i.test(p) && c.hostname !== p && (u = !0),
            u && !s && ((e = e || ((n = t('<a class="w-w3-badge"></a>').attr("href", "https://w3.com?utm_campaign=brandjs")),
            (r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/w3-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            })),
            (a = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/w3-badge-text.6faa6a38cd.svg").attr("alt", "Made in W3")),
            n.append(r, a),
            n[0])),
            d(),
            setTimeout(d, 500),
...
, function(t, e, n) {
    ...
    var r = window.$
      , i = n(53) && r.tram;
    /*!
         * W3._ (aka) Underscore.js 1.6.0 (custom build)
         * _.each
         * _.map
         * _.find
         * _.filter
    ...
    t.exports = function(t, e, n, a, u, c) {
        ...
        for (var E = s; ++d < l; ) {
            var g = t[(p = f[d])]
              , _ = e[p];
            if (a)
                var y = s ? a(_, g, p, e, t, c) : a(g, _, p, t, e, c);
...
, function(t, e, n) {
    ...
    e.createPluginInstance = function(t) {
        var e = window.W3.require("lottie").createInstance(t);
        return e.stop(),
        e.setSubframe(!0),
        e;
    }
    ...
    e.clearPlugin = function(t) {
        window.W3.require("lottie").createInstance(t).stop();
    }
    ;
}
, function(t, e, n) {
    "use strict";
    var r, i, o, a = n(0), u = a(n(16)), c = a(n(18)), s = n(0);
    Object.defineProperty(e, "__esModule", {
        value: !0
    }),
    ...
    function yt(t) {
        ...
        var w, S, R, N = (0,
        p.default)(n, "action.config.affectedElements", {})[_ || I] || {}, C = Boolean(N.id || N.selector), x = n && u(_t(n.target));
    ...
    var r = n(2)
      ...
      , T = function(t, e) {
        ...
        if (E && !g)
            ...
            for (var F = (O - _) / m, j = E.config.easing, k = h(j, F, f), X = 0, G = a.length; X < G; X++) {
                var U = a[X]
                  , V = y(s, U, E.config)
...
, function(t, e, n) {
    "use strict";
    var r, i = n(0), o = i(n(18)), a = i(n(16)), u = n(0);
    Object.defineProperty(e, "__esModule", {
        value: !0
    }),
    (e.default = void 0);
    var c, s, f, l = u(n(19)), d = u(n(238)), p = u(n(26)), v = u(n(257)), h = n(2), E = n(91), g = n(49), _ = n(9), y = h.EventTypeConsts, m = y.MOUSE_CLICK, I = y.MOUSE_SECOND_CLICK, T = y.MOUSE_DOWN, O = y.MOUSE_UP, b = y.MOUSE_OVER, A = y.MOUSE_OUT, w = y.DROPDOWN_CLOSE, S = y.DROPDOWN_OPEN, R = y.SLIDER_ACTIVE, N = y.SLIDER_INACTIVE, C = y.TAB_ACTIVE, x = y.TAB_INACTIVE, L = y.NAVBAR_CLOSE, D = y.NAVBAR_OPEN, P = y.MOUSE_MOVE, M = y.PAGE_SCROLL_DOWN, F = y.SCROLL_INTO_VIEW, j = y.SCROLL_OUT_OF_VIEW, k = y.PAGE_SCROLL_UP, X = y.SCROLLING_IN_VIEW, G = y.PAGE_FINISH, U = y.ECOMMERCE_CART_CLOSE, V = y.ECOMMERCE_CART_OPEN, B = y.PAGE_START, W = y.PAGE_SCROLL, H = "COMPONENT_ACTIVE", z = "COMPONENT_INACTIVE", Y = h.IX2EngineConstants.COLON_DELIMITER, K = _.IX2VanillaUtils.getNamespacedParameterId, Q = function(t) {
        return function(e) {
            return !("object" !== (0,
            a.default)(e) || !t(e)) || e;
        }
...
, function(t, e, n) {
    ...
    r.define("dropdown", (t.exports = function(t, e) {
        var n, u, c = e.debounce, s = {}, f = r.env(), l = !1, d = r.env.touch, p = ".w-dropdown", v = "w--open", h = i.triggers, E = 900, g = "focusout" + p, _ = "keydown" + p, y = "mouseenter" + p, m = "mousemove" + p, I = "mouseleave" + p, T = (d ? "click" : "mouseup") + p, O = "w-close" + p, b = "setting" + p, A = t(document);
        function w() {
            (n = f && r.env("design")),
            (u = A.find(p)).each(S);
        }
        ...
        function C(e) {
            if (!e.open) {
                ...
                e.hovering && i && A.on(m, e.mouseMoveOutside),
...
, function(t, e, n) {
    ...
    r.define("navbar", (t.exports = function(t, e) {
        var n, o, a, u, c = {}, s = t.tram, f = t(window), l = t(document), d = r.env(), p = '<div class="w-nav-overlay" data-wf-ignore />', v = ".w-nav", h = "w--open", E = "w--nav-dropdown-open", g = "w--nav-dropdown-toggle-open", _ = "w--nav-dropdown-list-open", y = "w--nav-link-open", m = i.triggers, I = t();
        function T() {
            r.resize.off(O);
        }
        function O() {
    ...
    r.define("tabs", (t.exports = function(t) {
        ...
        function T(e, n) {
            ...
            if (u !== e.current) {
                ...
                c.focus(),
                window.scrollTo(y, m),
                _.length && i.outro ? (_.each(E.outro),
                a(_).add("opacity " + i.outro + "ms " + o, {
                    fallback: s
                }).start({
                    opacity: 0
                }).then(function() {
        ...
        return ((o.ready = o.design = o.preview = _),
        (o.redraw = function() {
            (g = !0),
            _(),
            (g = !1);
    ...
    events: {
        e: {
            ...
            target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "1cf851e9-919a-91a7-d79a-5d364fa66bd7"
            },
            config: {
                loop: false,
                playInReverse: false,
        ...
        "e-3": {
            ...
            target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "1cf851e9-919a-91a7-d79a-5d364fa66bdf"
            },
            config: {
                loop: false,
                playInReverse: false,
            ...
            actionItemGroups: [{
                actionItems: [{
                    ...
                    config: {
                        ...
                        target: {
                            selector: ".search-bar",
                            selectorGuids: ["a77f1531-186e-5557-960b-1912fac5347b"]
                        },
                        widthValue: 100,
                        widthUnit: "%",
                        heightUnit: "PX"
